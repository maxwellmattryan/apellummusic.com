...
import { o as g } from './D4f8t5KQ.js'
import { w as p } from './BLScLmK0.js'
...
function B(e, t) {
	...
	if (r != null && r.textContent) {
		r.remove()
		let { body: a, ...l } = JSON.parse(r.textContent)
		const s = r.getAttribute('data-ttl')
		return (
			s && f.set(n, { body: a, init: l, ttl: 1e3 * Number(s) }),
			r.getAttribute('data-b64') !== null && (a = x(a)),
			Promise.resolve(new Response(a, l))
		)
	}
...
var v
const N = ((v = globalThis.__sveltekit_1atyyou) == null ? void 0 : v.base) ?? ''
var m
const L = ((m = globalThis.__sveltekit_1atyyou) == null ? void 0 : m.assets) ?? N ?? '',
	O = '1772557877034',
...
function ne(e, t, n) {
	...
	const a = e instanceof SVGAElement ? e.target.baseVal : e.target,
		l = !r || !!a || C(r, t, n) || (e.getAttribute('rel') || '').split(/\s+/).includes('external'),
		s = (r == null ? void 0 : r.origin) === A && e.hasAttribute('download')
	return { url: r, external: l, target: a, download: s }
}
function re(e) {
	let t = null,
		n = null,
	...
	for (; o && o !== document.documentElement; )
		r === null && (r = u(o, 'preload-code')),
			a === null && (a = u(o, 'preload-data')),
			t === null && (t = u(o, 'keepfocus')),
			n === null && (n = u(o, 'noscroll')),
			l === null && (l = u(o, 'reload')),
			s === null && (s = u(o, 'replacestate')),
			(o = R(o))
	function c(T) {
		switch (T) {
			case '':
...
function ae(e) {
	...
	return { notify: r, set: a, subscribe: l }
}
const S = { v: () => {} }
function se() {
...
function C(e, t, n) {
	return e.origin !== A || !e.pathname.startsWith(t)
		? !0
		: n
...
function oe(e) {}
const k = new Set(['load', 'prerender', 'csr', 'ssr', 'trailingSlash', 'config'])
;[...k]
const P = new Set([...k])
;[...P]
let h, y, d
const V = g.toString().includes('$$') || /function \w+\(\) \{\}/.test(g.toString())
V
	? ((h = {
			data: {},
			form: null,
	...
	: ((h = new (class {
			constructor() {
				i(this, 'data', $state.raw({}))
				i(this, 'form', $state.raw(null))
				i(this, 'error', $state.raw(null))
				i(this, 'params', $state.raw({}))
				i(this, 'route', $state.raw({ id: null }))
				i(this, 'state', $state.raw({}))
				i(this, 'status', $state.raw(-1))
				i(this, 'url', $state.raw(new URL('https://example.com')))
			}
	  })()),
	  (y = new (class {
			constructor() {
				i(this, 'current', $state.raw(null))
			}
	  })()),
	  (d = new (class {
			constructor() {
				i(this, 'current', $state.raw(!1))
			}
	  })()),
	  (S.v = () => (d.current = !0)))
function ue(e) {
